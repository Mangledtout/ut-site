      ...
      <section class="lp-section fade-up" style="background: #f8fafc; padding: 40px 5%;">
        <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
          ...
          <div class="lp-feature-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.5rem; text-align: left;">
            ${[['🧩', 'Child-Led Play', 'No scripts, no schedules — just curiosity and freedom to explore.'], ['🤝', 'Real Connection', 'Mixed-age friendships and face-to-face interaction that screens can never replace.'], ['🌿', 'Healthy Risks', 'Adventures that build confidence, resilience, and independence.'], ['☕', 'Grown Ups Too', 'A space to exhale — no hosting, no planning, no pressure… and definitely no tidy up!']].map(([icon, title, desc]) => `
